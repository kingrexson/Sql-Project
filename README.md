# Sql-Project
### Project Objective
Tht objective of this project is to find the BMT Loss rate of the GTEPs in Air Force Basic Military Training (BMT).  
### Project Background 
...
Open Trainees will be but in position in the later part of BMT and usually there to fill hard to fill position. GTEP trainees are assigned a job or Air Force Special Code (AFSC) 
